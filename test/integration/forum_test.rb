  ...
  module ForumTestDSL
    include ERB::Util
  	...
  	def reply_to_post(post,parameters)
  		...
  		assert_response :success
  		assert_tag 'h1', :content => "Responder a &#39;#{post.subject}&#39;"
  		...
  		assert_response :success
  		assert_template 'forum/index'
  		assert_tag 'a', :content => parameters[:post][:subject]
  	end
  	...
  	def delete_post(post)
  		...
  		:content => "Los posts de &#39;#{post.subject}&#39; se han eliminado correctamente."
  	end
  end
